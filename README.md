...
[![Travis Build Status](https://travis-ci.org/logstash-plugins/logstash-filter-csv_lookup.svg)](https://travis-ci.org/logstash-plugins/logstash-filter-csv_lookup)
